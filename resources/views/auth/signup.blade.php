  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <form action="{{route('signup')}}" method="post">
          ...
          <input type="text" name="name" class="form-control" placeholder="Nome" autocomplete="off" value="" required>
        ...
        <div class="input-group mt-3">
          <input type="password" name="password_confirmation" class="form-control" placeholder="Confirmar senha" autocomplete="off" value="" required>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
